Your application compiles now, based on the upgraded version of Spring Boot. All tests are passing! It bootstraps and runs without abending or generating warnings or errors.
