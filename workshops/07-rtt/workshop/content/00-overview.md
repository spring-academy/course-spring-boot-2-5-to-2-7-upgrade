Now that `pom.xml` file has been cleaned up and you've refactored the code to address any errors and deprecations, you can do a last little bit of housekeeping.
